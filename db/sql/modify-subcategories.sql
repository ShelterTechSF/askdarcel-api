...
insert into categories (id, created_at, updated_at, name, top_level, vocabulary, featured)
values (1_400_001, '13-DEC-20', '13-DEC-20', 'My landlord gave me an eviction notice and I need legal help', 'f', null, 'f');
insert into categories (id, created_at, updated_at, name, top_level, vocabulary, featured)
values (1_400_002, '13-DEC-20', '13-DEC-20', 'My landlord told me I would get evicted and I need advice', 'f', null, 'f');
insert into categories (id, created_at, updated_at, name, top_level, vocabulary, featured)
values (1_400_003, '13-DEC-20', '13-DEC-20', 'I have not been able to pay my rent and I do not know what to do', 'f', null, 'f');
insert into categories (id, created_at, updated_at, name, top_level, vocabulary, featured)
values (1_400_004, '13-DEC-20', '13-DEC-20', 'I am not getting along with my neighbor(s) and /or my landlord and I need advice', 'f', null, 'f');
